 ...
 * @author Sparsh Tyagi
 */
public class Vendor_Detail extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vendor_Detail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
